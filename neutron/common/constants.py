...
ROUTER_GATEWAY_STATUS_ACTIVE = 'ACTIVE'
ROUTER_GATEWAY_STATUS_DOWN = 'DOWN'
ROUTER_GATEWAY_STATUS_ERROR = 'ERROR'
...
DEVICE_OWNER_AGENT_GW_SHARED = "network:floatingip_agent_gateway_shared"
